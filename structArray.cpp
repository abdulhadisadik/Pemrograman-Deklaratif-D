...
main()
{
	...
	for ( int i=0; i<3; i++ )  
	{
	            ...
	            cout<<setw(11)<<setiosflags(ios::left)<<M[i].Nim;
	            cout<<setw(20)<<setiosflags(ios::left)<<M[i].Nama;
	            cout<<setw(18)<<setiosflags(ios::left)<<M[i].Mata_Kuliah;
	            cout<<setprecision(3)<<M[i].Nilai;   
	            cout<<"\n";         
	}
	cout << " ----------------------------------------------------------- \n";
	return 0;
